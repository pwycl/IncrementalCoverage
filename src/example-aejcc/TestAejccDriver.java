...
public class TestAejccDriver extends PropertyGuidedSEAbstractTest{

	public static void main(String[] args) {
		/**args for jdart*/
		String symMethod = "test.TestAejcc.start()";
		String symMethodSig = "test.TestAejcc.start()";
		String classname = "test.TestAejcc";
		...
		String mainClassName = "Ltest.TestAejcc";
...
//		boolean refineAnalysisResult = false;
		...
		Global.ParserPackage.add("ca.ubc.cs411.aejcc");
...
//			}
		...
		TestAejccDriver tester = new TestAejccDriver();
	...
	public static String[] createArgsSixpath(String inputFile, 
		...
		return new String[] {"+" + JFuzz.JFUZZ_INPUT_PROP + "=" + inputFile, 
                ...
                "+nhandler.clean=true",
                "+native_classpath=build/example-aejcc",
