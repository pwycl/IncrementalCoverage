...
public class TestJsonRaupachz extends PropertyGuidedSEAbstractTest{

	public static void main(String[] args) {
		/**args for jdart*/
		String symMethod = "test.TestJsonRaupachz.start()";
		String symMethodSig = "test.TestJsonRaupachz.start()";
		String classname = "test.TestJsonRaupachz";
		...
		String mainClassName = "Ltest.TestJsonRaupachz";
...
//		boolean refineAnalysisResult = false;
		...
		Global.ParserPackage.add("html/parser");
...
//			}
		...
		TestJsonRaupachz tester = new TestJsonRaupachz();
	...
	public static String[] createArgsSixpath(String inputFile, 
		...
		return new String[] {"+" + JFuzz.JFUZZ_INPUT_PROP + "=" + inputFile, 
                ...
                "+classpath=build/example-json-raupachz",
                ...
                "+nhandler.clean=true",
                "+native_classpath=build/example-json-raupachz",
