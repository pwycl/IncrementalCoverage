...
public class HtmlGrammar implements HtmlGrammarConstants {
  ...
  final public void elementSequence() throws ParseException {
    label_1:
    while (true) {
  ...
  final public void element() throws ParseException {Token text;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case TAG_START:{
      tag();
      break;
  ...
  final public void tag() throws ParseException {Token t, et;
...
if (et.kind == TAG_SLASHEND)
  ...
  final public void attribute_value() throws ParseException {
  ...
  public HtmlGrammarTokenManager token_source;
  ...
  public HtmlGrammar(InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public HtmlGrammar(InputStream stream, String encoding) {
