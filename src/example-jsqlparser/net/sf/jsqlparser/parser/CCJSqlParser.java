...
try {ParseException e = generateParseException();
  ...
  final public SetStatement Set() throws ParseException {
    ...
    try {
      ...
      jjtree.closeNodeScope(jjtn000, true);
      jjtc000 = false;
        {if (true) return new SetStatement(name,value).setUseEqual(useEqual);}
    } catch (Throwable jjte000) {
      if (jjtc000) {
        jjtree.clearNodeScope(jjtn000);
        jjtc000 = false;
    ...
    try {
      ...
      case K_UNIQUE:
        ...
        case K_DISTINCT:
          ...
          distinct = new Distinct(); plainSelect.setDistinct(distinct);
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case K_ON:
            jj_consume_token(K_ON);
            jj_consume_token(173);
...
try {OracleHint hint = null;
 ...
 /*@bgen(jjtree) AlterExpressionColumnDataType */
    SimpleNode jjtn000 = new SimpleNode(JJTALTEREXPRESSIONCOLUMNDATATYPE);
    boolean jjtc000 = true;
    jjtree.openNodeScope(jjtn000);String columnName = null;
    ...
    try {
      ...
      jjtree.closeNodeScope(jjtn000, true);
      jjtc000 = false;
        {if (true) return new AlterExpression.ColumnDataType(columnName, dataType, columnSpecs);}
    } catch (Throwable jjte000) {
      if (jjtc000) {
        jjtree.clearNodeScope(jjtn000);
        jjtc000 = false;
 ...
 /*@bgen(jjtree) AlterExpressionConstraintState */
    SimpleNode jjtn000 = new SimpleNode(JJTALTEREXPRESSIONCONSTRAINTSTATE);
    boolean jjtc000 = true;
    jjtree.openNodeScope(jjtn000);List<ConstraintState> retval = new ArrayList<ConstraintState>();
    try {
      label_68:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
 ...
 /*@bgen(jjtree) Wait */
    SimpleNode jjtn000 = new SimpleNode(JJTWAIT);
    boolean jjtc000 = true;
    jjtree.openNodeScope(jjtn000);Wait wait = new Wait();
    Token token = null;
    try {
