...
public class TestJavaccUrlPocDriver extends PropertyGuidedSEAbstractTest{

	public static void main(String[] args) {
		/**args for jdart*/
		String symMethod = "test.TestJavaccUrlPoc.start()";
		String symMethodSig = "test.TestJavaccUrlPoc.start()";
		String classname = "test.TestJavaccUrlPoc";
		...
		String mainClassName = "Ltest.TestJavaccUrlPoc";
...
//		boolean refineAnalysisResult = false;
		...
		Global.ParserPackage.add("io.mikael.poc");
...
//			}
		...
		TestJavaccUrlPocDriver tester = new TestJavaccUrlPocDriver();
	...
	public static String[] createArgsSixpath(String inputFile, 
		...
		return new String[] {"+" + JFuzz.JFUZZ_INPUT_PROP + "=" + inputFile, 
                ...
                "+classpath=build/example-javacc-url-poc",
                ...
                "+nhandler.clean=true",
                "+native_classpath=build/example-javacc-poc",
                ...
                "+nhandler.spec.delegate=com.google.common.base.Supplier"
		};
	}
