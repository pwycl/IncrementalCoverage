...
public class TestJsonparserJavaccDriver extends PropertyGuidedSEAbstractTest{

	public static void main(String[] args) {
		/**args for jdart*/
		String symMethod = "test.TestJsonparserJavacc.start()";
		String symMethodSig = "test.TestJsonparserJavacc.start()";
		String classname = "test.TestJsonparserJavacc";
		...
		String mainClassName = "Ltest.TestJsonparserJavacc";
...
//		boolean refineAnalysisResult = false;
		...
		Global.stage1_concolicTime = 50;
		Global.useStage3 = true;
		Global.useTokenCharConstr = true;

		Global.ParserPackage.add("jsonparser");
...
//			}
		...
		TestJsonparserJavaccDriver tester = new TestJsonparserJavaccDriver();
	...
	public static String[] createArgsSixpath(String inputFile, 
		...
		return new String[] {"+" + JFuzz.JFUZZ_INPUT_PROP + "=" + inputFile, 
                ...
                "+classpath=build/example-jsonparser-javacc",
                ...
                "+nhandler.clean=true",
                "+native_classpath=build/example-jsonparser-javacc",
