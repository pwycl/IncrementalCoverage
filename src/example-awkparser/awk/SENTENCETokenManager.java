package awk;/* SENTENCETokenManager.java */
/* Generated By:JavaCC: Do not edit this line. SENTENCETokenManager.java */

/** Token Manager. */
@SuppressWarnings("unused")public class SENTENCETokenManager implements SENTENCEConstants {
...
static final long[] jjtoSkip = {
   0x1eL, 
    ...
    private final int[] jjrounds = new int[150];
    private final int[] jjstateSet = new int[2 * 150];
