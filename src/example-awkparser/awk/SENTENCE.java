...
public class SENTENCE implements SENTENCEConstants {
    ...
    final public void Parse() throws ParseException, ParseException, TokenMgrError {
        Token t;
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
            case CONTINUE:{
                t = jj_consume_token(CONTINUE);
                System.out.println("@("+ t.beginLine+","+t.beginColumn+")\t"+t.toString());
                break;
            }
            case EXIT:{
    ...
    final public void Padrao() throws ParseException {
        if (jj_2_1(100)) {
            Exp_relacional();
            label_2:
            while (true) {
    ...
    final public void Acao() throws ParseException {
        Declaracao();
    }
    ...
    final public void D_Expressao() throws ParseException {
        Expressao();
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
            case FIM:{
    ...
    final public void D_funcao() throws ParseException {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
            case EXIT:{
    ...
    final public void D_if() throws ParseException {
        jj_consume_token(IF);
        jj_consume_token(ABRE_PARENTESES);
        Expressao();
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    ...
    final public void D_loop() throws ParseException {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
            case WHILE:{
    ...
    final public void D_control() throws ParseException {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
            case CONTINUE:{
    ...
    final public void D_lista() throws ParseException {
        label_4:
        while (true) {
            if (jj_2_10(100)) {
                D_Expressao();
    ...
    final public void D_funcao_matematica() throws ParseException {
    ...
    final public void D_funcao_io() throws ParseException {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
            case GETLINE:{
    ...
    final public void D_funcao_string() throws ParseException {
    ...
    final public void Print_lista() throws ParseException {
        if (jj_2_21(100)) {
            jj_consume_token(VAR);
        } else {
            switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    ...
    final public void Exp_relacional() throws ParseException {
        Exp_atribuicao();
        label_8:
        while (true) {
            if (jj_2_24(100)) {
    ...
    final public void Exp_not() throws ParseException {
        label_10:
        while (true) {
            switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
                case 41:{
    ...
    final public void Exp_atribuicao() throws ParseException {
        label_11:
        while (true) {
            if (jj_2_26(100)) {
                ;
    ...
    final public void Exp_soma() throws ParseException {
        Exp_multiplicacao();
        label_12:
        while (true) {
            if (jj_2_27(100)) {
    ...
    final public void Exp_multiplicacao() throws ParseException {
        Exp_potencia();
        label_13:
        while (true) {
            if (jj_2_28(100)) {
    ...
    final public void Exp_potencia() throws ParseException {
        label_14:
        while (true) {
            if (jj_2_29(100)) {
                ;
    ...
    final public void Exp_negacao() throws ParseException {
        label_15:
        while (true) {
            switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
                case 46:{
    ...
    final public void Exp_inc_dec() throws ParseException {
        if (jj_2_33(100)) {
            Exp_simples();
            label_16:
            while (true) {
    ...
    final public void Exp_simples() throws ParseException {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
            case VAR:{
                jj_consume_token(VAR);
                break;
    ...
    final public void Var_string() throws ParseException {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
            case VAR:{
                jj_consume_token(VAR);
                break;
    ...
    public SENTENCETokenManager token_source;
