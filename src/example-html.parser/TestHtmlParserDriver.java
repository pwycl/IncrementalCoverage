...
public class TestHtmlParserDriver extends PropertyGuidedSEAbstractTest{

	public static void main(String[] args) {
		/**args for jdart*/
		String symMethod = "test.TestHtmlParser.start()";
		String symMethodSig = "test.TestHtmlParser.start()";
		String classname = "test.TestHtmlParser";
		...
		String mainClassName = "Ltest.TestHtmlParser";
...
//			}
		...
		TestHtmlParserDriver tester = new TestHtmlParserDriver();
	...
	public static String[] createArgsSixpath(String inputFile, 
		...
		return new String[] {"+" + JFuzz.JFUZZ_INPUT_PROP + "=" + inputFile, 
                ...
                "+classpath=build/example-html.parser",
                ...
                "+nhandler.clean=true",
                "+native_classpath=build/example-html.parser",
