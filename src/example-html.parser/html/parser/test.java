...
//----------------------------
  static final public String start() throws ParseException {
    HTML_DOC();
    {if (true) return "\u005cn---------------\u005cnValid Html Document\u005cn"+"TD Count="+TD_Count+"\u005cnTR Count="+TR_Count;}
    throw new Error("Missing return statement in function");
  }

  static final public String HTML_DOC() throws ParseException {
                   String content="no strings";
    jj_consume_token(ST);
    ...
    jj_consume_token(HTML);
    jj_consume_token(ND);
    System.out.print("HTML - > "+content+'\u005cn');
    {if (true) return content;}
    throw new Error("Missing return statement in function");
  }

  static final public String DOC_HEAD() throws ParseException {
                   String content="no strings";
    jj_consume_token(ST);
    ...
    jj_consume_token(HEAD);
    jj_consume_token(ND);
    System.out.print("Head - > "+content+'\u005cn');
    {if (true) return content;}
    throw new Error("Missing return statement in function");
  }

  static final public String DOC_BODY() throws ParseException {
                   String content="no strings";
    jj_consume_token(ST);
    ...
    jj_consume_token(BODY);
    jj_consume_token(ND);
    System.out.print("Body - > "+content+'\u005cn');
    {if (true) return content;}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public void TD() throws ParseException {
  ...
  static final public String TR() throws ParseException {
             String content="no strings";
    ...
    TR_Count++;
    System.out.print("TR ["+TR_Count+"]- > "+content+'\u005cn');
    {if (true) return content;}
    throw new Error("Missing return statement in function");
  }

  static final public String Title() throws ParseException {
                String content="no strings";
    ...
    System.out.print("Title - > "+content+'\u005cn');
    {if (true) return content;}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public String Paragraph() throws ParseException {
    ...
    System.out.print("P - > "+content+'\u005cn');
    {if (true) return content;}
    throw new Error("Missing return statement in function");
  }

  static final public String Anchor() throws ParseException {
                 String content="no strings";
    ...
    System.out.print("Anchor - > "+content+'\u005cn');
    {if (true) return content;}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public String IMG() throws ParseException {
    ...
    System.out.print("IMG - > "+content+'\u005cn');
    {if (true) return content;}
    throw new Error("Missing return statement in function");
  }

  static final public String DIV() throws ParseException {
              String content="no additional strings";
    ...
    System.out.print("DIV - > "+content+'\u005cn');
    {if (true) return content;}
    throw new Error("Missing return statement in function");
  }

  static final public String Span() throws ParseException {
               String content="no additional strings";
    ...
    System.out.print("Span - > "+content+'\u005cn');
    {if (true) return content;}
    throw new Error("Missing return statement in function");
  }

  static final public String details() throws ParseException {
                  String content="no details string";
    ...
    System.out.print("Details - > "+content+'\u005cn');
    {if (true) return content;}
    throw new Error("Missing return statement in function");
  }

  static final public String summary() throws ParseException {
                  String content="no details string";
    ...
    System.out.print("Summary - > "+content+'\u005cn');
    {if (true) return content;}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public void List() throws ParseException {
    jj_consume_token(ST_OL);
                ListItem_Count=0; System.out.print("---------------\u005cn");
    label_15:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case ST_LI:
    ...
    jj_consume_token(ND_OL);
      System.out.print("OL [Count] - > "+ListItem_Count+'\u005cn');
      System.out.print("---------------\u005cn");
  }

  static final public String ListItem() throws ParseException {
                   String content="";
    ...
    ListItem_Count++;
    System.out.print(ListItem_Count+". "+content+'\u005cn');
    {if (true) return content;}
    throw new Error("Missing return statement in function");
  }

  static final public String Button() throws ParseException {
                 String content="";
    ...
    System.out.print("Button - > "+content+'\u005cn');
    {if (true) return content;}
    throw new Error("Missing return statement in function");
  }

  static final public String Header() throws ParseException {
                 String content="no strings",Selected="H";
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ST_H1:
    ...
    System.out.print(Selected+" - > "+content+'\u005cn');
    {if (true) return content;}
    throw new Error("Missing return statement in function");
  }
