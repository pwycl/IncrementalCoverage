...
public class Parser/*@bgen(jjtree)*/implements ParserTreeConstants, ParserConstants {/*@bgen(jjtree)*/
  protected JJTParserState jjtree = new JJTParserState();private JEP     jep;
        ...
        public Node parseStream(java.io.Reader stream, JEP jep_in)
                ...
                try{
	                char first = this.token_source.input_stream.readChar(); // make symbolic by readChar!
...
//	                System.out.println(first);
	                ...
	                this.token_source.input_stream.backup(1);
	                char last = this.token_source.input_stream.readChar();
...
***************************************************************/
 ...
 /*@bgen(jjtree) Start */
  ...
  jjtree.openNodeScope(jjtn000);
    try {
      if (jj_2_1(1)) { // can generate constraints
        Expression();
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {  // jj_ntk is the kind of jj_nt, since the jj_ntk is the kind of the nextToken!
        case 0:
          jj_consume_token(0);
          break;
        case SEMI:
...
*/
  ...
  final private boolean jj_3R_20() { // can read char 
    if (jj_3R_18()) return true;
    return false;
  }
  ...
  /**
   * yhb think it gets the nextToken, the kind of which is kind! otherwise throw an exception!
   * */
