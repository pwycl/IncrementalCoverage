...
import nl.bigo.curta.expression.*;
...
public class Curta {
    ...
    public Map<Integer, Expression> expressions;
    ...
    CurtaNode root;
    public void stage1_2 (String source) throws ParseException {
        CurtaParser parser = new CurtaParser(new java.io.StringReader(source));
        root = parser.ast();
    }

    public void stage3 (){
        root.eval(variables,functions,expressions);
    }
