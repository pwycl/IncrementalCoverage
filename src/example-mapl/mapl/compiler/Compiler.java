...
import mapl.visitor.VisitorAdapter;
...
public class Compiler extends VisitorAdapter<String> {
    ...
    // Implementing a mapl.visitor method. E.g. A visit method for integer constants, that is an experssion
    ...
    n.e. could be a boolean value, a method calls, a binop addition. Which mapl.visitor method do we use?
    ...
    In every AST classes there is an accept method. It takes a mapl.visitor and calls it back.
    ...
    N.E.ACCEPT(THIS) 
    N.ACCEPT(THIS) is a recursive call and is a infinite call, which will cause the mapl.compiler to crash
