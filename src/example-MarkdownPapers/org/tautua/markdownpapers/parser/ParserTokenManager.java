...
//            if(MarkdownPapersConfig.SYMB_FLAG==false || MarkdownPapersConfig.TOKEN_SYMB==false)
...
//            if(MarkdownPapersConfig.SYMB_FLAG==false || MarkdownPapersConfig.TOKEN_SYMB==false)
            if (!Debug.isTokenSymb())
            {
               System.out.println("getNextToken image: "+matchedToken.image+"   "+(int)matchedToken.image.charAt(0));
               System.out.println("getNextToken kind: "+ParserConstants.tokenImage[matchedToken.kind]);
               System.out.println("-----------buf pos: "+input_stream.tokenBegin);
               return matchedToken;
            }
