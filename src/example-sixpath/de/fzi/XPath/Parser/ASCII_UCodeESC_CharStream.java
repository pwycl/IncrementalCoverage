...
public final class ASCII_UCodeESC_CharStream
{
  ...
  {     
     ...
     {
        --inBuf;
        int index = tokenBegin = (bufpos == bufsize - 1) ? (bufpos = 0): ++bufpos;
        char c = buffer[index];
      //   char r = Debug.makeConcolicChar("sym_char_" + count, ""+(int)c);
        //System.out.println("BeginToken ------" + count +"--"+ r + ":"+(int)r);
        count++;
      //   return r;
         return c;
     }
...
//  }  
  ...
  public final char readChar() throws IOException{
	  char c = readChar1();
	//   char r = Debug.makeConcolicChar("sym_char_" + count, ""+(int)c);
	 // System.out.println("readchar ------" + count +"--"+ r + ":"+(int)r);
	  count++;
	//   return r;
	  return c;
  }
  
  public final char readChar1() throws java.io.IOException
  {
     if (inBuf > 0)
     {
        --inBuf;
