...
//	public final int token_old() {
////		if(FastjsondevConfig.SYMB_FLAG==false)
////			System.out.println("pos: " + pos+"   Token: "+JSONToken.name(token));
////
////		if(FastjsondevConfig.SYMB_FLAG==false || FastjsondevConfig.TOKEN_SYMB==false){
////			return token;
////		}
//
//		if (token == EOF)
...
//
//		if (srcIdx <= this.bp){
//			tokenImage = subString(srcIdx, this.bp - srcIdx);
//			srcIdx = this.bp;
//		}
//
...
//
//		int c;
//		if (oldtoken == token && oldbp == this.bp) {
//			c = Debug.makeConcolicInteger("sym_token_" + (token_index - 1),
//					"" + (int) token , "1");
//
////			Debug.GenTokenStringByConcolic(""+token,tokenImage);
...
//		}
//
//		System.out.println("Token: " + token +", image: " + tokenImage);
